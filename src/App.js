...
import CTATool from './components/CTATool';
  ...
  const data = [
    {
      ...
      deskripsi: 'When a young street hustler, a retired bank robber and a terrifying psychopath land themselves in trouble, they must pull off a series of dangerous heists to survive in a city in which they can trust nobody, least of all each other.'
    },
    {
      id: 'rdr-2',
      ...
      pengembang: 'Rockstar North',
      penerbit: 'Rocstar Games',
      deskripsi: 'Arthur Morgan and the Van der Linde gang are outlaws on the run. With federal agents and the best bounty hunters in the nation massing on their heels, the gang must rob, steal and fight their way across the rugged heartland of America in order to survive. As deepening internal divisions threaten to tear the gang apart, Arthur must make a choice between his own ideals and loyalty to the gang who raised him.'
    },
    {
      id: 'wukong',
    ...
    },
    {
      ...
      deskripsi: 'Marvel Rivals is a Super Hero Team-Based PVP Shooter! Assemble an all-star Marvel squad, devise countless strategies by combining powers to form unique Team-Up skills and fight in destructible, ever-changing battlefields across the continually evolving Marvel universe!'
    },
    {
    ...
    <div className='x-body'>
      ...
      <div>
        ...
        <div className='x-menu-game'>
          <GameMenu data={data} categoryGames={categoryGames} onClick={handleTriggerClick}/>
        </div>
      </div>
      <DetailGames isOpen={isPopupOpen} onClose={closePopup} value={popupValue} data={data}/>
